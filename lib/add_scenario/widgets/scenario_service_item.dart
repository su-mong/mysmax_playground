...
import '../pages/add_loop_scenario_page.dart';
import '../pages/add_service_scenario_page.dart';
...
class _ScenarioServiceItemState extends State<ScenarioServiceItem> {
  ...
  void initState() {
    ...
    function = viewModel.getFunctionByName(widget.item.serviceName);
        ...
        children: [
          ...
          SizedBox(
            ...
            child: PopupMenuButton<String>(
              ...
              onSelected: (String result) {
                if (result == '서비스') {
                  AddServiceScenarioPage(parentBlock: widget.item)
                      .push(context);
                } else if (result == '조건') {
                  AddConditionScenarioPage(parentBlock: widget.item)
                      .push(context);
                } else if (result == '반복') {
