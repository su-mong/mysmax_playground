  ...
  void initState() {
    ...
    if(widget.conditionBlock.state == ConditionBlockState.ifElse) {
      ...
      if(widget.conditionBlock.waitUntilBlock.condition != null) {
        ...
        /*_untilConstantNumberController.text = ;
        _untilConstantStringController.text = ;
        _untilConstantHourController.text = ;
        _untilConstantMinuteController.text = ;*/
      }
                  ...
                  case ConditionBlockState.ifElse:
                    return RichText(
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: '\n\n${_conditionsForIf.map(
                              (condition) => '${(condition.firstValue is ValueServiceExpression) ? condition.firstValue.serviceName : condition.firstValue} '
                                  '${condition.conditionType?.value} '
                                  '${(condition.lastValue is ValueServiceExpression) ? condition.lastValue.serviceName
                                    : (condition.lastValue is LiteralExpression) ? condition.lastValue.value : condition.lastValue}'
                            ).join('\n')}\n\n',
                        ...
                        children: [
                          TextSpan(
                            text: _useConditionForUntil
                                ...
                                '${(_conditionsForUntil[0].lastValue is ValueServiceExpression) ? _conditionsForUntil[0].lastValue.serviceName
                                  : (_conditionsForUntil[0].lastValue is LiteralExpression) ? _conditionsForUntil[0].lastValue.value : _conditionsForUntil[0].lastValue}'
                                  '\n\n'
                                : '\n\n'
...
class _IfElsePage extends StatelessWidget {
  ...
  bool _isWeatherServiceSelected(int index) => conditions[index].firstValue != null
      && conditions[index].firstValue is ValueServiceExpression
      && (conditions[index].firstValue as ValueServiceExpression).serviceName == _weatherServiceName;

  bool _isDateTimeServiceSelected(int index) => conditions[index].firstValue != null
      && conditions[index].firstValue is ValueServiceExpression
      && (conditions[index].firstValue as ValueServiceExpression).serviceName == _dateTimeServiceName;
              ...
              if(_isWeatherServiceSelected(index))
                _ConstantWeatherWidget(
                  selectedWeather: (conditions[index].lastValue != null
                      ...
                      ? (conditions[index].lastValue as LiteralExpression).value.toString().toWeatherStateFromValue
                      : null,
                  onSelect: (weather) {
                    setNewLastValue(
                      index,
                ...
                _ConstantDateTimeWidget(
                  ...
                  dateTime: (conditions[index].lastValue != null
                      && conditions[index].lastValue is LiteralExpression)
                      ? DateTime.fromMillisecondsSinceEpoch((conditions[index].lastValue as LiteralExpression).value * 1000)
                      : null,
                  onChange: (dateTime) {
                    if(dateTime != null) {
                      setNewLastValue(
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, index) => GestureDetector(
                  ...
                  onTap: () {
                    if(editMode) {
                      setFirstValue(thingValueListExceptWeatherAndTimestamp[index]);
                    }
                  },
                  child: Padding(
            ...
            if(isWeatherServiceExist)
              GestureDetector(
                ...
                onTap: () {
                  if(editMode) {
                    setFirstValue(
                      thingValueList.firstWhere((element) => element.name == _weatherServiceName),
                    );
                  }
                },
                child: Container(
            ...
            if(isDateTimeServiceExist)
              GestureDetector(
                ...
                onTap: () {
                  if(editMode) {
                    setFirstValue(
                      thingValueList.firstWhere((element) => element.name == _dateTimeServiceName),
                    );
                  }
                },
                child: Container(
        ...
        child: ExpansionTile(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, index) => GestureDetector(
                  ...
                  onTap: () {
                    if(editMode) {
                      setLastValue(thingValueListExceptWeatherAndTimestamp[index]);
                    }
                  },
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(2, 16, 0, 16),
            ...
            EditorVariableListWidget(
              ...
              onSelect: (variable) {
                setLastValueByExpression(
                  LiteralExpression(variable, literalType: LiteralType.VARIABLE),
                );
              },
            ),
          ],
        ...
        child: ExpansionTile(
          ...
          children: [
            Wrap(
              spacing: 4,
              runSpacing: 4,
              children: WeatherState.values.map(
